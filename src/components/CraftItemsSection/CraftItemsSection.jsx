    ...
    <div>
      <div className="p-4 md:p-12">
        ...
        >
          ...
          intricately designed jewelry to charming home decor, each item in our
          store is carefully crafted with love and attention to detail. We
          believe that every piece tells a story and adds a touch of personality
          to your space.
        </Slide>
      </div>
      {!dataLoading ? (
