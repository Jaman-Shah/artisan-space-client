      ...
      <footer className="bg-black text-white border-t mt-8">
        ...
        <div className="footer p-4 md:p-10">
          <nav className=" w-full flex flex-col justify-center items-center">
            ...
            <a className="link link-hover">Craft Sells</a>
            <a className="link link-hover">Art Sells</a>
          </nav>
          <nav className="w-full flex flex-col justify-center items-center">
            <h6 className="footer-title">Contact With</h6>
            <a className="link link-hover">+000000</a>
            <a className="link link-hover">+011111</a>
            <a className="link link-hover">Email: example@gmail.com</a>
            <a className="link link-hover">fax : 000000</a>
          </nav>
          <nav className="w-full flex flex-col justify-center items-center ">
            <h6 className="footer-title text-center">Social</h6>
            <div className="grid grid-flow-col gap-4">
              <a className="border p-2 hover:bg-green-500 hover:border-none">
                <svg
